...
class Drone_AR_Flight:
    ...
    def _draw(self, ar_cmd, ar_val):
        if self.code_latest_view > 0:
            ...
            puttxt4 = str(self.code_latest)
            cv2.putText(self.frame, puttxt4, (self.code_latest_rect[0], int(self.code_latest_rect[1] + self.code_latest_rect[3] / 2)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3)
